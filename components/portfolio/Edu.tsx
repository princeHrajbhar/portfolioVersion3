...
const Edu: React.FC<EduProps> = ({ id }) => {
  ...
  const timelineData: TimelineItem[] = [
    ...
    },
    {
      ...
      description: [
        ...
        '1st Rank in TypeMaster Challenge,2 spot in High accuracy data entry challenge using excel'
      ],
      type: 'education',
      skills: ['MS Excel', 'MS Word', 'Power Point', 'Tally Prime', 'HTML', 'CSS', 'IT', 'Grafic Designing using autodesk Maya & Blender', 'Video Editing']
    },
    {
      id: 'exp-1',
      title: 'Intern',
  ...
  return (
    <section id={id} className="">
      ...
      >
        {/* Deterministic particles - same on server and client */}
